...
class _RecordsScreenState extends ConsumerState<RecordsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final params = TransactionListParams(from: from, to: to);
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text('$_year', style: const TextStyle(color: AppColors.textPrimary, fontSize: 16)),
                  InkWell(
                    onTap: () async {
                      final picked = await showDatePicker(
                        context: context,
                    ...
                    child: Row(
                      children: [
                        Text(_monthNames[_month - 1], style: const TextStyle(color: AppColors.textPrimary)),
                  ...
                  return Card(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          _SummaryChip(label: 'Expenses', value: FormatHelpers.currency(expense)),
                          _SummaryChip(label: 'Income', value: FormatHelpers.currency(income)),
                          _SummaryChip(label: 'Balance', value: FormatHelpers.currency(balance)),
                        ],
                      ),
                    ),
                  );
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            if (dayExpense > 0)
              Text(
                'Expenses: ${FormatHelpers.currency(dayExpense)}',
